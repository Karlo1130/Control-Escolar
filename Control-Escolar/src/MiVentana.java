...
public class MiVentana extends JFrame {
	...
	public void Eliminar() {
		...
		eliminar= new JPanel();
		eliminar.setSize(525,700);
		eliminar.setLocation(0,0);
		eliminar.setLayout(null);
        eliminar.setBackground(Color.decode("#dce7ec"));
        
        JLabel eliminarI= new JLabel("Eliminar Informacion");
        eliminarI.setFont(new Font("Comic Sans", Font.BOLD,30));
        eliminarI.setBounds(110, 10, 300, 50);
        eliminar.add(eliminarI);
...
//		CrearUsuario(username, apellidos, FechaN, Correo, Num, password);
	...
	public void actualizarUsuario(JTextField nombreText, JTextField apellidosText, 
			JTextField correo,JTextField NumeroTelefono, JPasswordField contraseñaText, JPasswordField contraseñaText2, int numUsuario) {
...
//		CrearUsuario(username, apellidos, FechaN, Correo, Num, password);
	...
	public Object[][] getMaestros() {
		...
		Object[][] data = new Object[getNumeroDeMaestros()][columns.length];
	...
	public Object[][] getAlumnos() {
		...
		String[] columns = {"Nombre", "Apellidos", "Fechad de nacimiento", "Correo", "Telefono","Grado de Estudios"};
		Object[][] data = new Object[getNumeroDeMaestros()][columns.length];
